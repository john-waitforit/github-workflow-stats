      ...
      <div className="min-h-screen flex flex-col justify-center">
        <main>
          ...
          <p className="text-center">
            Remix for server rendered web applications, pretty good setup for
            eslint, prettier, git hooks, etc. and friction-less and robust UI
            development with TailwindCSS, DaisyUI and Headless UI
          </p>
        </main>
